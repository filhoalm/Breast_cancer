...
#### Table 1: Characteristics of the Breast Cancer Cohort from 2003 - 2020 by Breast Cancer Subtype
...
The majority of patients across all subtypes presented with localized disease, with the highest proportion observed in the HR+/HER2- subtype (67.59%). Distant metastasis was more common in the HR-/HER2- subtype compared to the HR+/HER2+ subtype. Specifically, 10.99% of patients in the HR-/HER2- subtype presented with distant metastasis, while only 4.33% were HR+/HER2+.

Non-Hispanic White (NHW) individuals showed the highest proportions across all breast cancer subtypes, with the greatest percentage for HR+/HER2- (68.69%). Non-Hispanic Black (NHB) individuals had higher proportion for HR-/HER2- subtype (20.60%).


Across all subtypes, there is an overall gradient in SES groups, increasing from the lowest to highest SES. The highest SES group (Group 5) shows a significant percentage across all subtypes, most notably in the HR+/HER2- subtype (33.30%). The higher SES groups overall have a higher proportion in most subtypes, particularly in the HR+/HER2- subtype. The HR-/HER2- subtype shows a slightly different pattern, with a lower proportion of the highest SES group: Group 1 (Lowest SES) comprises 13.637% (6,890 cases) of HR+/HER2+, and 17.659% (8,935 cases) for the lowest SES quintile.

Most of cases across all breast cancer subtypes did not come from persistent poverty census tracts, with the HR+/HER2- having the highest percentages (93.72%).
...
Individuals with the HR-/HER2+ subtype showed the highest hazard ratio (HR) of 1.95 (95% CI 1.85-2.06), followed by HR+/HER2+ with an HR of 1.89 (95% CI 1.81-1.97).

Localized stage cancer presented an HR of 1.96 (95% CI 1.92-2.00), highlighting the severity of early disease stage in individuals from lower SES quintiles. On the other hand, Distant stage cancer showed a lower HR of 1.40 (95% CI 1.35-1.46).

In the highest SES quintile, low HRs were noted for the HR-/HER2+ subtype (HR 0.51, 95% CI 0.41-0.62) and Localized stage cancer (HR 0.51, 95% CI 0.47-0.55).

Those with the HR+/HER2- subtype in the lowest SES quintile had an HR of 1.74 (95% CI 1.71-1.78), whereas individuals from the highest SES quintile with the same cancer subtype showed an HR of 0.57 (95% CI 0.54-0.61).
...
combined_data <- rbind(plot_data_tab5, plot_data_tab5a)
...
ggplot(combined_data, aes(y = label, x = Hazard_Rate, color = SES_quintile, label = sprintf("%.2f", Hazard_Rate))) +
  ...
  scale_color_manual(values = c("lowest SES" = "darkred", "highest SES" = "darkblue")) +  # Set custom colors for SES quintiles
